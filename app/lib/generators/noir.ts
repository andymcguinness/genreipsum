export const noirGrammar = {
  ...
  sentence: [
    'the #detective# took a drag from #possession# and considered the #case_element#',
    ...
    'the #victim# was found in the #crime_scene# with #evidence# nearby',
    '#authority# wanted answers, but the #detective# had only #detective_has#',
    'the case #case_descriptor# like #simile# in this godforsaken city',
    '#antagonist# ran this town, and everybody knew it except the #innocent_party#',
    'a #mysterious_object# sat on the desk, #object_state# in the #lighting#',
    'the #location# was the kind of place where #noir_observation#',
    '#dialogue_tag#, the #character# said, #dialogue_descriptor#',
    'following the #clue# led straight to the #shady_location# on #street_name#',
    'the #detective# had seen enough #crime_type# to know #detective_knowledge#',
    ...
    'the #item# was the key to everything, or so the #source# claimed',
    'between the #faction# and the #faction#, this town was #town_state#',
    '#detective# knew #detective_realization#, but proving it was another story',
    'the #evidence# told a story, if you knew how to read it',
    'in this line of work, you learn that #noir_wisdom#',
    'the #suspect# had an alibi that was #alibi_quality#, like everything else in this case',
